...
![Version: 1.0.355](https://img.shields.io/badge/Version-1.0.355-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.3.323](https://img.shields.io/badge/AppVersion-0.3.323-informational?style=flat-square) 
...
| agentic.image.tag | string | `"0.0.2"` |  |
...
| elasticsearch.clusterName | string | `"elastic"` |  |
...
| elasticsearch.master.extraEnvVars[0].value | string | `"-server -Xms2G -Xmx2G"` |  |
